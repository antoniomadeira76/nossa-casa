...
export const REGISTO_APP = [
  ...
  { v: '1.12.1', d: '14/09/2026', k: 'alterado', a: 'A App', t: 'A segunda revisão de coerência. O botão principal de todas as folhas passou a ficar fixo em baixo, sempre à vista — em dez folhas estava no fim do conteúdo e só aparecia depois de rolar. Os títulos de secção e de folha ficaram todos com maiúsculas iniciais. O vazio da lista de compras e o da troca de tarefas passaram a ter o mesmo desenho dos outros, com ícone e dica. Duas pastilhas da Saúde passaram a seguir o modo escuro. E todo o número se escreve no mesmo campo, com «−» e «+»: os pontos da tarefa, a garantia em dias, o plano de tomas, o limite de um envelope e o preço estimado de um artigo' },
